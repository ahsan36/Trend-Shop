...
<head>
    ...
    <title>Trend Shop - Product details for men</title>
...
<body>
    ...
    <section id="header">
        <a href="product.html"> <img src="../img/Trend.png" class="logo" alt=""></a>
    ...
    <div class="flex-box">
        ...
        <div class="right">
            ...
            <div class="btn-box">
                <a href="../Shopping-Cart/index.php"><button class="buy-btn">Shop Now</button></a>
            </div>
    ...
    <section id="product1" class="section-p1">
        ...
        <div class="pro-container">
            <div class="pro">
                <a href="product.html"><img src="img/products/f2.jpg" alt=""></a>
                <div class="des">
                    <span>clothing</span>
                ...
                <a class="cart" href="product.html">See More</a>
            </div>

            <div class="pro">
                <a href="product.html"><img src="img/products/f3.jpg" alt=""></a>
                <div class="des">
                    <span>adidas</span>
            ...
            <div class="pro">
                <a href="product.html"><img src="img/products/f4.jpg" alt=""></a>
                <div class="des">
                    <span>clothing</span>
                    <h5>Colorful Pattern Shirt</h5>
                    <div class="star">
            ...
            <div class="pro">
                <a href="product.html"><img src="img/products/f5.jpg" alt=""></a>
                <div class="des">
                    <span>adidas</span>
                    <h5>Cartoon Astronaut T-Shirts</h5>
                    <div class="star">
    ...
    <div class="foot-panel1">
        <a href="product.html">Back to top</a>
    </div>
    ...
    <footer class="section-p1">
        ...
        <div class="col">
            <h4>My Account</h4>
            <a href="../Contact/contact.php">Sign In</a>
            <a href="../AddCart/cart.php">View Cart</a>
            <a href="../AddCart/cart.php">My Wishlist</a>
