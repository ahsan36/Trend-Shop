...
<body>
    ...
    <section id="header">
        <a href="shop.php"> <img src="../img/Trend.png" class="logo" alt=""></a>
        ...
        <div>
            ...
            <div class="search">
                ...
                <a href="shop.php"><button class="btn">Search</button></a>
            </div>
            ...
            <ul id="navbar">
                ...
                <a href="shop.php" id="close"><i class="fas fa-times"></i></a>
            </ul>
        </div>
    ...
    <section id="product1" class="section-p1">
        ...
        <div class="pro-container">
            ...
            <div class="pro">
                <a href="../Product Details/product.php"><img src="../img/products/n2.jpg" alt=""></a>
                <div class="des">
                    <span>clothing</span>
            ...
            <div class="pro">
                <a href="../Product Details/product.php"><img src="../img/products/n4.jpg" alt=""></a>
                <div class="des">
                    <span>clothing</span>
                    <h5>Different Color Shirt</h5>
                    <div class="star">
            ...
            <div class="pro">
                <a href="../Product Details/product.php"><img src="../img/products/f2.jpg" alt=""></a>
                <div class="des">
                    <span>adidas</span>
                    <h5>Cartoon Astronaut T-Shirts</h5>
                    <div class="star">
            ...
            <div class="pro">
                <a href="../Product Details/product.php"><img src="../img/products/f5.jpg" alt=""></a>
                <div class="des">
                    <span>clothing</span>
                    <h5>Casual Boy's Shirt</h5>
                    <div class="star">
            ...
            <div class="pro">
                <a href="../Product Details/product.php"><img src="../img/products/n5.jpg" alt=""></a>
                <div class="des">
                    <span>adidas</span>
                    <h5>Formal Shirts</h5>
                    <div class="star">
    ...
    <section id="pagination" class="section-p1">
        <a href="shop1.php">1</a>
        <a href="Women/women.php">2</a>
        <a href="Women/women.php"><i class="fas fa-long-arrow-alt-right"></i></a>
    </section>
